...
?>
<div class="ms-3 h-100" id="quiSommesNous">
	<h1 class="mb-3">QUI SOMMES-NOUS ?</h1>
	<p>ECE MarketPlace est un site réservé à la communauté ECE Paris.<br />
		Ce site vous permet d’acheter à un prix négociable des meubles, des objets d’art, des accessoires VIP ou encore du matériel scolaire.</p>
