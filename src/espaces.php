	...
	<main class="container">
		...
		<div class="row mb-3">
			<div class="col mx-auto d-flex justify-content-center">
				<a href="./seconnecter.php?role=administrateur" class="btn btn-primary rounded-pill col-4">Espace Administrateur</a>
			</div>
		</div>
		<div class="row mb-3">
			<div class="col mx-auto d-flex justify-content-center">
				<a href="./seConnecter.php?role=acheteur" class="btn btn-primary rounded-pill col-4">Espace Acheteur</a>
			</div>
		</div>
		<div class="row mb-3">
			<div class="col mx-auto d-flex justify-content-center">
				<a href="./seConnecter.php?role=vendeur" class="btn btn-primary rounded-pill col-4">Espace Vendeur</a>
			</div>
		</div>
		<div class="row">
			<div class="col mx-auto d-flex justify-content-center">
				<a href="inscription.php" class="btn btn-primary rounded-pill col-4">Créer un compte</a>
			</div>
		</div>
	</main>
</body>
